...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6 pt-36 pb-16 text-center sm:pt-40 sm:pb-20 md:pt-44">
        {/* Eyebrow */}
        ...
        {/* Headline */}
        <h1 className="mt-4 font-extrabold tracking-tight text-white leading-[1.05] text-4xl sm:text-6xl md:text-7xl [text-wrap:balance]">
        ...
        {/* Subheading */}
        <p className="mx-auto mt-5 max-w-3xl text-base sm:text-xl text-[var(--fg-muted)]">
          DigitalMeve embeds a lightweight, invisible{" "}
          <span className="font-semibold">.MEVE</span> proof inside your file and issues
          an official certificate. Your document remains identical and readable
        ...
        >
          <Link
            href="/generate"
            className="btn btn-primary shadow-[0_0_45px_rgba(56,189,248,.25)]"
          >
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <span className="badge badge-green">Files preserved</span>
          <span className="badge">No account • No storage</span>
          <span className="badge badge-info">Free for individuals</span>
        </div>
      </div>
