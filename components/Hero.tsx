// components/Hero.tsx — v19 (clarity-first; a11y; reduced-motion; no global selectors)
"use client";
...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      ref={rootRef}
      aria-label="DigitalMeve — The simplest and safest way to prove a file’s authenticity."
      className="relative overflow-visible pb-[calc(84px+env(safe-area-inset-bottom))] sm:pb-20"
    >
      {/* Background FX (faible opacité → pas de gêne lisibilité / LCP) */}
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-5 pt-20 sm:pt-24 pb-4 text-center">
        ...
        >
          ...
          THE .MEVE STANDARD · Privacy-first · Verifiable anywhere
        </div>
        ...
        >
          The simplest and safest way to prove a file’s authenticity.
        </h1>
        ...
        >
          Digital proof, simple and private. Generate and verify on your device — no account, no storage, no tracking.
        </p>
        ...
        >
          Open standard · On-device · No server required
        </p>
        ...
        >
          <Link
            href="/generate"
            aria-label="Protect a file (free plan available)"
          ...
          <Link
            href="/verify"
            aria-label="Verify a file’s authenticity"
