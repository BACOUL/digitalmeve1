...
export default function GenerateLoading() {
  return (
    ...
    >
      <p className="sr-only">Loading generate page…</p>
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 sm:py-12">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-7 w-44 rounded-full bg-white/5 ring-1 ring-white/10 motion-safe:animate-pulse"
              />
            ))}
          </div>
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <div className="ml-auto h-4 w-56 rounded bg-white/10 ring-1 ring-white/10 motion-safe:animate-pulse" />
          </div>

          {/* Result card */}
          <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-5 shadow-sm">
            <div className="h-5 w-32 rounded bg-white/10 ring-1 ring-white/10 motion-safe:animate-pulse" />
            ...
            <div className="mt-5 h-9 w-64 rounded-xl bg-white/10 ring-1 ring-white/10 motion-safe:animate-pulse" />
          </div>

          {/* Micro-claims skeleton */}
          <div className="mt-10 mx-auto h-3 w-80 rounded bg-white/10 ring-1 ring-white/10 motion-safe:animate-pulse" />
        </div>
      </section>
    </main>
  );
