...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      {/* HERO — déjà stylé dans components/Hero.tsx */}
      <Hero />
        ...
        <div className="container-max py-14">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            ...
            <div className="card p-6 animate-fadeIn">
              ...
              <p className="mt-2 sub">Works with common formats; your file stays on your device.</p>
            ...
            <div className="card p-6 animate-fadeIn" style={{ animationDelay: "60ms" }}>
              ...
              <p className="mt-2 sub">We add a lightweight, invisible proof and prepare your certificate.</p>
            </div>
            ...
            <div className="card p-6 animate-fadeIn" style={{ animationDelay: "120ms" }}>
              ...
              <p className="mt-2 sub">Share your file and certificate. Anyone can check it in seconds.</p>
      ...
      <section className="section-dark">
        <div className="container-max pb-16">
          ...
          <p className="sub mt-2">Designed for everyone — from individuals to enterprises. Simple to use, built for trust.</p>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="card p-6">
              ...
              <p className="mt-2 text-sm text-[var(--fg-muted)]">A durable proof lives with the file. No viewer or plugin required.</p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="mt-2 text-sm text-[var(--fg-muted)]">Your files remain clean and portable — open them as usual.</p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="mt-2 text-sm text-[var(--fg-muted)]">Protect personal files at no cost. Pro plans scale your workflows.</p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="mt-2 text-sm text-[var(--fg-muted)]">We never keep your files. Generate and check in seconds.</p>
            </div>
          </div>
      ...
      <section className="section-dark">
        <div className="container-max pb-20">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="card p-6">
              <span className="chip chip-ok">For Individuals — Free</span>
            ...
            <div className="card p-6">
              <span className="chip chip-info">For Businesses — API &amp; Dashboard</span>
