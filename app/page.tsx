      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:py-24">
          <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-emerald-300">
            ...
            Free for Individuals <span className="text-slate-400">·</span> No signup
          </span>
          ...
          <p className="mt-4 max-w-2xl text-lg text-slate-300">
            Certify your documents instantly. Your file stays readable, your proof is portable.
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-xs text-slate-400">
            <span className="inline-flex items-center gap-1">
              <BadgeCheck className="h-3.5 w-3.5 text-emerald-300" aria-hidden /> Embedded for PDF & PNG
            </span>
            <span className="hidden sm:inline">•</span>
            <a href="/verify" className="inline-flex items-center gap-1 underline decoration-sky-400/60 hover:text-slate-200">
              <ShieldCheck className="h-3.5 w-3.5" aria-hidden />
              Verify a proof
            </a>
            <span className="hidden sm:inline">•</span>
            <a href="/personal" className="inline-flex items-center gap-1 underline decoration-sky-400/60 hover:text-slate-200">
              <Users className="h-3.5 w-3.5" aria-hidden />
              For Individuals
            </a>
          </div>
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-slate-400">
              We add an invisible proof to your file. It stays fully readable and uniquely yours.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-slate-400">
              Keep a portable certificate (<code className="text-slate-300">.meve.json</code>) or share the verified file anytime.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur">
            ...
            <ul className="mt-3 space-y-2 text-slate-400">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-emerald-300" aria-hidden /> Unlimited personal use
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-emerald-300" aria-hidden /> Readable files with built-in proof (PDF/PNG)
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-emerald-300" aria-hidden /> Optional portable certificate (.meve.json)
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-emerald-300" aria-hidden /> No accounts. No storage. Instant.
              </li>
            </ul>
            <div className="mt-5 flex gap-3">
              ...
              >
                Explore personal <ArrowRight className="h-3.5 w-3.5" aria-hidden />
              </a>
              <a
                href="/generate"
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur">
            ...
            <ul className="mt-3 space-y-2 text-slate-400">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-sky-300" aria-hidden /> API & SDKs for automated certification
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-sky-300" aria-hidden /> Verification at scale
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-sky-300" aria-hidden /> Email/domain verification for <span className="text-slate-300">Pro</span> badge
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="mt-0.5 h-4 w-4 text-sky-300" aria-hidden /> SLA, support & roadmap alignment
              </li>
            </ul>
            <div className="mt-5 flex gap-3">
              <a
